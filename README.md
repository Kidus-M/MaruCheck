...
upload. Version `0.2.1` keeps reproducible `.maru/generated/` state out of normal Git changes and
is staged for the next manual publication. Contributors changing the CLI itself can still build
