  ...
  public async handle(message: unknown): Promise<JsonRpcResponse | undefined> {
    ...
    if (message.method === "initialize") {
      ...
      return response(id, {
        ...
        instructions:
          "Query MaruCheck project context and Quality Contracts before changing behavior. Analyze the diff, assess risk, and create an inspectable verification plan after edits. Draft creation never approves product intent.",
