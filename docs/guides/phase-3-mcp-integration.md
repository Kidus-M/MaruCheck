...
```powershell
codex mcp add maru -- npx --yes marucheck@0.2.1 mcp
codex mcp list
```
...
```powershell
claude mcp add maru --scope project -- npx --yes marucheck@0.2.1 mcp
claude mcp list
```
