...
```powershell
codex mcp add maru -- npx --yes marucheck@0.5.0 mcp
codex mcp list
```
...
```powershell
claude mcp add maru --scope project -- npx --yes marucheck@0.5.0 mcp
claude mcp list
```
